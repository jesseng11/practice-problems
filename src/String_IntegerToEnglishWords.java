...
public class String_IntegerToEnglishWords {
	public static HashMap<Integer, String> map = new HashMap<Integer, String>();
	
	public static void main(String[] args) {
		System.out.println(numToWords(0));
		System.out.println(numToWords(10));
		System.out.println(numToWords(329));
		System.out.println(numToWords(39479));
		System.out.println(numToWords(3749479));
		System.out.println(numToWords(1238473829));
	}
